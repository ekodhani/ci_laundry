            ...
            <div class="card-body">
                <form action="" method="post">
                    <div class="form-group">
                        ...
                        <input type="text" id="nama-paket" class="form-control form-control-sm" placeholder="Masukkan Nama Paket" name="nama_paket" value="<?= $detail['nama_paket']?>">
                        <?= form_error('nama_paket', '<small class="text-danger pl-3">', '</small>'); ?>
                    </div>
                    <div class="form-group">
                        <label class="form-control-label" for="harga">Harga</label>
                        <input type="text" id="harga" class="form-control form-control-sm" placeholder="Masukkan Harga Paket" name="harga_paket" value="<?= $detail['harga']?>">
                    ...
                    <div class="form-group text-center">
                        ...
                        <a href="<?= base_url('admin/paket'); ?>" class="btn btn-outline-secondary btn-sm"><i class="ni ni-fat-remove"></i> Cancel</a>
                    </div>
                </form>
            </div>
          </div>
				...
				<?php foreach($paket as $p) :?>
                  <tr>
                    ...
                    <td>
                        ...
                        <a href="<?= base_url('admin/hapus_paket/'). $p['id_paket']; ?>" class="badge badge-pill badge-secondary"><i class="fas fa-trash"></i> Hapus</a>
                    </td>
                  </tr>
				<?php endforeach; ?>
                </tbody>
